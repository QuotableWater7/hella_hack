...
Song.prototype.search = function(args, callback, error) {
    this.en.apiRequest('song/search', args, callback, error);
}
...
Catalog.prototype.list = function(callback, error) {
    this.en.apiRequest('catalog/list', {}, callback, error);
}
